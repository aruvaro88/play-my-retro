...
User.create(users)
  ...
  .then(() => User.findByIdAndUpdate(userIdArray[0], { friends: [userIdArray[1], userIdArray[5], userIdArray[6]] }, { new: true }))
  .then(() => User.findByIdAndUpdate(userIdArray[1], { friends: [userIdArray[3], userIdArray[2], userIdArray[4]] }, { new: true }))
  .then(() => User.findByIdAndUpdate(userIdArray[2], { friends: [userIdArray[6], userIdArray[4]] }, { new: true }))
